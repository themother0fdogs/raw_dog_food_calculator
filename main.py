...
weightLabel.grid(row=0, column=0, sticky= tk.W + tk.E, padx=20)
weightInput.grid(row=0, column=1, sticky= tk.W + tk.E, padx=20)
weightDrop.grid(row=0, column=2, sticky= tk.W + tk.E, padx=20)
goalLabel.grid(row=1, column=0, sticky= tk.W + tk.E, padx=20)
goalInput.grid(row=1, column=1, sticky= tk.W + tk.E, padx=20)
...
#grid
    muscleLabel.grid(row=0, column=0, sticky=tk.W + tk.E, padx=10)
    muscleOutput.grid(row=0, column=1, sticky=tk.W + tk.E, padx=10)
    muscleMetric.grid(row=0, column=2, sticky=tk.W + tk.E, padx=10)

    boneLabel.grid(row=1, column=0, sticky=tk.W + tk.E, padx=10)
    boneOutput.grid(row=1, column=1, sticky=tk.W + tk.E, padx=10)
    boneMetric.grid(row=1, column=2, sticky=tk.W + tk.E, padx=10)

    liverLabel.grid(row=2, column=0, sticky=tk.W + tk.E, padx=10)
    liverOutput.grid(row=2, column=1, sticky=tk.W + tk.E, padx=10)
    liverMetric.grid(row=2, column=2, sticky=tk.W + tk.E, padx=10)

    organLabel.grid(row=3, column=0, sticky=tk.W + tk.E, padx=10)
    organOutput.grid(row=3, column=1, sticky=tk.W + tk.E, padx=10)
    organMetric.grid(row=3, column=2, sticky=tk.W + tk.E, padx=10)

    attn = tk.Label(calc, text="*Some secreting examples include: \n brain, kidney, spleen, pancreas, and testicles. ",
                    font=('Arial', 12))
    attn.grid(row=4, column=0, columnspan=50, sticky = tk.W + tk.E, pady=50)
